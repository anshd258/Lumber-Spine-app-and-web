                                      ...
                                      child: WidgetToImage(
                                        builder: (key) {
                                          ...
                                          return MyNeumorCont(
                                            ...
                                            xtitle: "Time (s)",
                                            ytitle: "X",
                                            gradientColor: const Color.fromARGB(
                                                255, 0, 146, 230),
                                ...
                                Expanded(
                                  ...
                                  child: WidgetToImage(
                                    builder: (key) {
                                      ...
                                      return PlaneGraph(
                                        data:
                                            state.data.ft!.amp!.ref1Unfiltered!,
                                        time: state.data.ft!.amp!.time!,
                                        xtitle: "Amplitude",
                                        ytitle: "",
                          ...
                          SizedBox(
                            ...
                            child: BlueButton(
                              ...
                              onTap: () async {
                                ...
                                Size pdfSize = key10!.currentContext!.size!;
                                try {
                                  final bytes0 = await Utils.capture(key10);
